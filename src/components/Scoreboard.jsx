    ...
    <>
      ...
      <div className="absolute top-4 start-4 z-[60]">
        <button 
          ...
          className="flex items-center gap-2 p-2 sm:px-4 sm:py-2 bg-slate-800/80 hover:bg-slate-700 backdrop-blur-md text-slate-200 rounded-full border border-white/15 transition-all duration-75 active:translate-y-[2px] shadow-md group cursor-pointer"
        >
          <svg 
