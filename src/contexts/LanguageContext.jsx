...
export const translations = {
  en: {
    ...
    rulesClash: "• Clash of Rondas: If both players have Ronda, the higher pair wins all points.",
    rulesTringaVsRonda: "• Tringa vs Ronda: Tringa beats Ronda and wins all points.",
    rulesCounterAttack: "• Counter Attack: Countering a Derba (Taawida).",
    rulesUltimateAttack: "• Ultimate Attack: Countering a Counter Attack.",
    rulesFinalFail: "• Final Fail: Missing the last card gives +5 points to the opponent.",
    rulesKingFinish: "• King Finish: Winning the last trick with a King gives +5 points.",
    rulesAsFinish: "• As Finish: Winning the last trick with an Ace gives +5 points to the opponent.",
    announcements: {
      ronda: "Ronda! (+1) - {name}",
  ...
  fr: {
    ...
    rulesClash: "• Clash de Rondas : Si les deux joueurs ont Ronda, la paire la plus haute gagne.",
    rulesTringaVsRonda: "• Tringa vs Ronda : Tringa bat Ronda et gagne tous les points.",
    rulesCounterAttack: "• Contre-Attaque : Contrer une Derba (Taawida).",
    rulesUltimateAttack: "• Attaque Ultime : Contrer une Contre-Attaque.",
    rulesFinalFail: "• Échec Final : Rater la dernière carte donne +5 points à l'adversaire.",
    rulesKingFinish: "• King Finish : Gagner le dernier pli avec un Roi donne +5 points.",
    rulesAsFinish: "• As Finish : Gagner le dernier pli avec un As donne +5 points à l'adversaire.",
    announcements: {
      ronda: "Ronda ! (+1) - {name}",
      tringa: "Tringa ! (+5) - {name}",
      missa: "Missa ! (+1) - {name}",
  ...
  de: {
    ...
    rulesClash: "• Clash of Rondas: Wenn beide Spieler Ronda haben, gewinnt das höhere Paar.",
    rulesTringaVsRonda: "• Tringa vs Ronda: Tringa schlägt Ronda und gewinnt alle Punkte.",
    rulesCounterAttack: "• Gegenangriff: Kontern einer Derba (Taawida).",
    rulesUltimateAttack: "• Ultimativer Konter: Kontern eines Gegenangriffs.",
    rulesFinalFail: "• Finaler Fehlschlag: Die letzte Karte verpassen gibt dem Gegner +5 Punkte.",
    rulesKingFinish: "• King Finish: Den letzten Stich mit einem König gewinnen gibt +5 Punkte.",
    rulesAsFinish: "• As-Finish: Den letzten Stich mit einem Ass gewinnen gibt dem Gegner +5 Punkte.",
    announcements: {
      ronda: "Ronda! (+1) - {name}",
      tringa: "Tringa! (+5) - {name}",
      missa: "Missa! (+1) - {name}",
  ...
  ar: {
    ...
    rulesClash: "• تصادم الروندات: إذا كان لدى كلا اللاعبين روندا، فإن الزوج الأعلى يفوز.",
    rulesTringaVsRonda: "• ترينجا ضد روندا: ترينجا تتغلب على روندا وتفوز بجميع النقاط.",
    rulesCounterAttack: "• هجوم مضاد: الرد على ضربة (تعويدة).",
    rulesUltimateAttack: "• هجوم نهائي: الرد على الهجوم المضاد.",
    rulesFinalFail: "• خيبة الختام: تفويت البطاقة الأخيرة يعطي الخصم +5 نقاط.",
    rulesKingFinish: "• نهاية الملك: الفوز بالحيلة الأخيرة بملك يعطي +5 نقاط.",
    rulesAsFinish: "• نهاية بالآص: الفوز بالحيلة الأخيرة بآص يعطي الخصم +5 نقاط.",
    announcements: {
      ronda: "روندا (+1) - {name}",
